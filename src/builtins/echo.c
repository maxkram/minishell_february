...
/*   Updated: 2024/03/01 19:24:45 by device           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @return 1 if it's a valid '-n' flag, 0 if it's not a flag, or EXIT_SUCCESS if it's just a hyphen without 'n'
*/
int	is_flag(char *arg)
{
	if (arg && *arg == '-')
 ...
 * @note The echo command prints the given arguments to the standard output, separated by spaces, and followed by a newline character.
